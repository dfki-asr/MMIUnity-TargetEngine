...
*/
        ...
        */
        ...
        {
            string val = PlayerPrefs.GetString("ProxyUser");
            if ((val != null) && (val != "") && (regPass != "") && (regPass.Length == 32))
            {
                try
                {
            ...
            val = PlayerPrefs.GetString("ProxyPass");
            if ((val != null) && (val != "") && (regPass != "") && (regPass.Length == 32))
            {
                try
                {
            ...
            val = PlayerPrefs.GetString("ProxyAddress");
            if (val != "")
                proxyHttps = val.ToString();
            val = PlayerPrefs.GetString("ProxyPort");
            if (val != "")
                proxyPort = val.ToString();
            val = PlayerPrefs.GetString("UseProxy");
            if (val != "")
                useProxy = (val.ToString() == "True");
            val = PlayerPrefs.GetString("UseProxyAuthentication");
            if (val != "")
                useProxyAuthenictation = (val.ToString() == "True");
            val = PlayerPrefs.GetString("UseHTTPS");
            if (val != "")
        ...
        {
            PlayerPrefs.SetString("ProxyUser", EncryptString(regPass, proxyUser));
            PlayerPrefs.SetString("ProxyPass", EncryptString(regPass, proxyPassword));
            PlayerPrefs.SetString("ProxyAddress", proxyHttps);
            PlayerPrefs.SetString("ProxyPort", proxyPort);
            PlayerPrefs.SetString("UseProxy", useProxy.ToString());
            PlayerPrefs.SetString("UseHTTPS", useHttpsProxy.ToString());
            PlayerPrefs.SetString("UseProxyAuthentication", useProxyAuthenictation.ToString());
        }
